...
public class CameraPreviewOld implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public CameraPreviewOld(int PreviewlayoutWidth, int PreviewlayoutHeight,
